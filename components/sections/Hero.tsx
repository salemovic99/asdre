      ...
      <div className="sticky top-0 flex h-screen w-full items-center justify-center overflow-hidden">
        ...
        >
          ...
          <motion.div style={textStyle} className="flex flex-col items-center">
            <h2 className="mt-8 font-serif text-xl font-medium leading-tight tracking-[0.35em] whitespace-nowrap uppercase text-foreground/90 sm:text-2xl md:text-3xl lg:text-4xl">
              {words.map((word, i) => (
