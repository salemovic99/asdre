...
import { InfiniteRing } from "@/components/visual/Shapes";
  ...
  return (
    ...
    >
      <div className="relative flex w-full max-w-4xl flex-col items-center text-center">
        {/* floating ring behind the words */}
        <FloatingObject
          rotateDuration={60}
          spin="y"
          amplitude={16}
          className="pointer-events-none absolute -z-[1] opacity-90"
        >
          <InfiniteRing className="w-[70vw] max-w-[420px]" />
        </FloatingObject>
